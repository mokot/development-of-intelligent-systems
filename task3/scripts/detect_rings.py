...
class The_Ring:
    ...
    def image_callback(self, data):
        ...
        # Do histogram equlization -> TLDR: Improves the image
        ...
        # Fine me two elipses with same center :D
        # "Sometimes it works relatively well"
        # BEST -> TORUS IN PCL
        candidates = []
        ...
        print("Processing is done! found", len(
            candidates), "candidates for rings")
        ...
        for c in candidates:
            ...
            self.get_pose(
                e1, float(np.mean(depth_image[x_min:x_max, y_min:y_max]))/1000.0)
